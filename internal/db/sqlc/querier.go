...
type Querier interface {
	...
	ListGuildsPaginated(ctx context.Context, limit int32, offset int32) ([]Guild, error)
	...
	ListJTCParentChannelsPaginated(ctx context.Context, guildID string, limit int32, offset int32) ([]JtcParentChannel, error)
	CountJTCParentChannels(ctx context.Context, guildID string) (int64, error)
	...
	ListReactionRolesByGuildPaginated(ctx context.Context, guildID string, limit int32, offset int32) ([]ReactionRole, error)
	CountReactionRolesByGuild(ctx context.Context, guildID string) (int64, error)
